...
?>
<main class="property-details theme-3 ms-special-table">
  <div id="full-main">
    ...
    <div id="full-slider">
      ...
      <div class="moptions">
        <ul class="slider-option">
          ...
          <?php else: ?>
              <?php if( !empty($latAlternative) && !empty($lngAlternative)){ $response['payload']['lat_building']=$latAlternative; $response['payload']['lng_building']=$lngAlternative; ?>
              <li>
                <button class="option-switch" id="show-map" data-view="map"><?php echo __('map view', IDXBOOST_DOMAIN_THEME_LANG); ?></button>
              </li>
              <?php } ?>
        ...
        <div class="container">
          ...
          <div class="main-content">
            ...
            <div class="list-details active">
              <h2 class="title-amenities no-tab"><?php echo __('Amenities', IDXBOOST_DOMAIN_THEME_LANG); ?></h2>
          ...
          <?php echo do_shortcode('[idxboost_sub_area_inventory building_id="'.$atts['building_id'].'" load="ajax" ]'); ?>
  ...
  if (array_key_exists('type_floor_plan', $response['payload']) && $response['payload']['type_floor_plan'] =='2') {
    ...
    if (array_key_exists('floor_plan_view_grid', $response['payload']) && !empty($response['payload']['floor_plan_view_grid']) ) {
      ...
      <?php if (!empty($floor_plan_grid_keyplan)) { ?>
        <div class="ib-fp-img">
          <img src="<?php echo $floor_plan_grid_keyplan; ?>">
        </div>        
      <?php } ?>
...
?>
              ...
              <div class="form-content large-form">
                <div class="avatar-content">
                  ...
                  <div class="avatar-information">
                    ...
                    <a class="phone-avatar" href="tel:<?php echo preg_replace('/[^\d]/', '', $agent_info_phone); ?>" title="<?php echo __('Call to', IDXBOOST_DOMAIN_THEME_LANG); ?> <?php echo flex_agent_format_phone_number($agent_info_phone); ?>"><?php echo __('Ph', IDXBOOST_DOMAIN_THEME_LANG);?>. <?php echo flex_agent_format_phone_number($agent_info_phone); ?></a>
                    <?php endif; ?>
                  </div>
                </div>
                    ...
                    <ul class="gform_fields">
                      ...
                      <li class="gfield comments">
                        ...
                        <div class="ginput_container">
                          <textarea autocorrect="off" autocapitalize="off" spellcheck="false" autocomplete="disabled" autocomplete="disabled" class="medium textarea" name="message" type="text" placeholder="Comments" rows="10" cols="50"><?php echo __('I am interested in', IDXBOOST_DOMAIN_THEME_LANG).' '.$building_default_address; ?>
                          </textarea>
                        </div>
                      </li>
        ...
        <div class="aside">
          ...
          <ul class="property-information ltd d-hidden">
            ...
            <?php if($type_building==0){ ?>
            <li class="item-list"> <span class="ib_inventory_listing_text"><?php echo __('Average Listing Price', IDXBOOST_DOMAIN_THEME_LANG); ?></span><span class="ib_inventory_listing_price">$0</span></li>
