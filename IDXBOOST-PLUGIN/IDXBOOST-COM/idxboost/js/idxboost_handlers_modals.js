...
var ib_path_filters=window.document.URL;
            ...
            if (IB_MODAL_WRAPPER.length && IB_MODAL_TPL.length) {
                ...
                if ("undefined" === typeof Cookies.get("_ib_disabled_forcereg")) {
                    if (true === IB_HAS_LEFT_CLICKS) {
                        ...
                        if ("yes" === __flex_g_settings.anonymous) {
                            if (  ( (__flex_g_settings.hasOwnProperty("force_registration")) && (1 == __flex_g_settings.force_registration) )  || ((typeof idxboost_force_registration) !=false && idxboost_force_registration !=false)  ) {
