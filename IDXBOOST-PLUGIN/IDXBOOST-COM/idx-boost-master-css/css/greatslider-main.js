(function($) {
    ...
    var autoPlayStatus = $propertiesSlider.parents("#featured-section").attr("data-auto");
    var autoPlayspeed = $propertiesSlider.parents("#featured-section").attr("data-spped");

    if(autoPlayStatus !== "" && autoPlayStatus !== undefined){
			autoPlay = true;
		}else{
      autoPlay = false;
    }
