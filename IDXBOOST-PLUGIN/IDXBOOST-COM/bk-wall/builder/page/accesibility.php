...
<div class="ms-access-content-terms">
    ...
    <div class="ms-access-accordion">
      ...
      <div class="accordion-item">
        ...
        <div class="ms-access-content">
          <p>If you find a keyboard or mouse difficult to use, speech recognition software such as <a href="https://www.nuance.com/dragon.html" target="_blank">Dragon NaturallySpeaking</a> may help you navigate web pages and online services. This software allows the user to move focus around a web page or application screen through voice controls.</p>
        </div>
      </div>
