    ...
    <main id="flex-about-theme">
      ...
      <div class="c-flex">
        <article class="flex-block-description">
          ...
          <?php the_content(); ?>
          <!--<div class="box-btn">
            <a href="<?php echo $idx_txt_link_welcome_about_firts; ?>" title="View our recent sales" class="clidxboost-btn-link idx_txt_text_welcome_about_first"><span><?php echo $idx_txt_text_welcome_about_first;?></span></a>
            <a href="<?php echo $idx_txt_link_welcome_about_second; ?>" title="View my exclusive listings" class="clidxboost-btn-link idx_txt_text_welcome_about_second"><span><?php echo $idx_txt_text_welcome_about_second ;?></span></a>
          </div>-->
        </article>
        <div class="flex-block-image"><img src="<?php echo $post_thumbnail_url; ?>" alt="<?php the_title(); ?>"></div>
      </div>
